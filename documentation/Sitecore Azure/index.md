...
## Official Sitecore Documentation and Resources

The following documents relate to the **Sitecore Azure module**. This module relies on a number of Microsoft Azure Services (and therefore utilizies Microsoft Azure in a PaaS capacity). Make sure that you are aware of the **size limitations** (especially of the Azure SQL Database service) if you decide to go down this route.
...
The following articles have come out of Sitecore Support and the Technical Consulting community.

### Sitecore Azure Module

- [Error installing a management certificate for Sitecore Azure without the appropriate application pool permissions](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/error-installing-a-management-certificate-for-sitecore-azure-without-the-appropriate-application-pool-permissions.md)
- [How to add a new Sitecore Azure environment file](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-add-a-new-sitecore-azure-environment-file.md)
- [How to use a custom Azure Cloud Service in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-use-a-custom-azure-cloud-service-in-sitecore-azure.md)
- [How to use a custom Azure Storage Service in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-use-a-custom-azure-storage-service-in-sitecore-azure.md)
- [How to use a custom Azure SQL Databases Service in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-use-a-custom-azure-sql-databases-service-in-sitecore-azure.md)
- [How to use a custom Azure Traffic Manager Service in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-use-a-custom-azure-traffic-manager-service-in-sitecore-azure.md)
- [How to add a custom connection string in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-add-a-custom-connection-string-in-sitecore-azure.md)
- [How to add a custom database in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-add-a-custom-database-in-sitecore-azure.md)
- [How to share a database between Farms in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-share-a-database-between-farms-in-sitecore-azure.md)
- [How to prevent Sitecore Azure from adding Publishing Targets to the on-premises instance](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-prevent-sitecore-azure-from-adding-publishing-targets-to-the-on-premises-instance.md)
- [How to configure SSL in Sitecore Azure](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-configure-ssl-in-sitecore-azure.md)
- [How to view Sitecore logs in Sitecore Azure deployments](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-view-sitecore-logs-in-sitecore-azure-deployments.md)
- [How to clean up a failed Sitecore Azure deployment](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-clean-up-a-failed-sitecore-azure-deployment.md)

### Sitecore and Visual Studio

- [How to deploy Sitecore databases to Azure SQL Database](https://github.com/olegburov/sitecore-azure-content/blob/master/articles/how-to-deploy-sitecore-databases-to-azure-sql-database.md)
